...
public class ResidentService {
  ...
  public AggregationResponse handle(AggregationRequest request) {
    ...
    JpaRepository<Resident, Long> repository = repositoryRouter.getRepository(city);
    if (repository == null) {
      return new AggregationResponse(false, "Unknown city: " + city, null);
    }
    ...
    return switch (request.getAction()) {
      ...
      default -> new AggregationResponse(false, "Unknown action: " + request.getAction(), null);
    };
  }
}

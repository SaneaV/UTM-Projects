...
—оздать класс Bool Ц логические переменные. ќпределить операторы "+" Ц логическое
»Ћ», "*" Ц логическое » "^" Ц »— Ћё„»“≈Ћ№Ќќ≈ »Ћ», как дружественные
функции, а операторы "==" и "!=" как методы класса. ќператоры должны позвол€ть
осуществлени€ операций, как с переменными данного класса, так и с переменными
встроенного int. (≈сли целое число отлично от нул€, считаетс€ что переменна€ истинна,
в противном случае ложна). ѕерегрузить операторы Ђ<<ї и Ђ>>ї.

...
—оздать класс Set Ц множество действительных чисел, использу€ динамическую пам€ть.
ќпределить конструкторы: по умолчанию и копий. ќпределить функции включени€
нового элемента во множество, определени€ принадлежности элемента множеству,
сложени€, вычитани€ и пересечени€ множест

...
result = display_data_for_price_range('Lab 3/merged_smartphone_data.csv', 500, 1000)
if result is not None:
    print(result.to_string(index=False))
else:
    print (None)
# Это вернет все строки с ценами от 1000 до 2000 из файла 'merged_smartphone_data.csv'
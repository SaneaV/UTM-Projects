...
url = "https://glovoapp.com/md/ro/chisinau/nakiri-sushi-ksn?content=roll-uri-c.2277723438&section=roll-uri-s.4869730596"
response = requests.get(url)
if response.status_code == 200:
    soup = BeautifulSoup(response.text, "html.parser")
    soup = soup.find("div", id="roll-uri-s.4869730596")

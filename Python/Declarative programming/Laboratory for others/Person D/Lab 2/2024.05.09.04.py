...
url = "https://glovoapp.com/md/ro/chisinau/norisushi?content=roll-c.1151783271&section=roll-s.2705594714"
response = requests.get(url)
if response.status_code == 200:
    soup = BeautifulSoup(response.text, "html.parser")
    soup = soup.find("div", id="roll-s.2705594714")
